...
partial edge={#1}{/reeb graph settings/.cd,outline edge={#1}{\thickness-.5*\linewidth}{fill=gray!40}}{relative up to={#2}{},relative down to={0}{},relative slice={#2}{slice}{\pic[#4,line width=1pt,fill=gray]{slice circle 1={.07 cm between (slice-2) and (slice-1)}};}},
},
...
partial edge={#1}{}{relative slice={-.2}{slice}{\pic[opacity=0,fill opacity=1,fill=gray!40]{slice circle 1={.07cm between (slice-2) and (slice-1)}};\pic[#4,line width=1pt]{slice circle 2={.07 cm between (slice-2) and (slice-1)}};}},
},
...
/utils/exec={\pic[#6,line width=1,fill=gray]{slice circle 1=.07cm between (slice-r-2) and (slice-l-1)};},},
...
/utils/exec={\pic[opacity=0,fill opacity=1,fill=gray!40]{slice circle 1=.07cm between (slice-r-2) and (slice-l-1)};\pic[#6,line width=1]{slice circle 2=.07cm between (slice-r-2) and (slice-l-1)};},
},
manifold 1/.style={
...
absolute up to/.style={/reeb graph settings/partial edge settings/.cd,absolute up to={#1}{}},
relative down to/.style={/reeb graph settings/partial edge settings/.cd,relative down to={#1}{}},
absolute down to/.style={/reeb graph settings/partial edge settings/.cd,absolute down to={#1}{}},
}
