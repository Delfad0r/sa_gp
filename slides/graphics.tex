...
partial edge/.code n args={3}{	\getedgecolor{#1}\begin{scope}\gdef\codeToExecuteAfterEdgeUp{}\gdef\codeToExecuteAfterEdgeDown{}\pgfkeys{reeb graph settings/.cd,edge #1/.get=\edge,partial edge settings/.cd,#3}\pgfkeysalso{edge={#1}{#2}}\end{scope}\codeToExecuteAfterEdgeUp\codeToExecuteAfterEdgeDown},
