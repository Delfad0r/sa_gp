...
\pic{reeb graph={
minimum/.style={
partial edge={#1}{/reeb graph settings/.cd,outline edge={#1}{\thickness+.5*\linewidth}{fill=black}}{relative up to={.2}{},relative down to={0}{}},
...
maximum/.style={
partial edge={#1}{/reeb graph settings/.cd,outline edge={#1}{\thickness+.5*\linewidth}{fill=black}}{relative down to={-.2}{},relative up to={-0.001}{}},
...
partial edge={#1}{/reeb graph settings/.cd,outline edge={#2}{\thickness+.5*\linewidth}{fill=black},outline edge={#3}{\thickness+.5*\linewidth}{fill=black}}{relative down to={-.2}{\coordinate (p);},relative up to={-0.001}{}},
partial edge={#2}{/reeb graph settings/.cd,outline edge={#2}{\thickness+.5*\linewidth}{fill=black}}{relative up to={.2}{},relative down to={0}{},/utils/exec={\tikzmath{coordinate \p;\p=(p);}},absolute slice={\py}{slice-l}{}},
partial edge={#3}{/reeb graph settings/.cd,outline edge={#3}{\thickness+.5*\linewidth}{fill=black}}{relative up to={.2}{},relative down to={0}{},/utils/exec={\tikzmath{coordinate \p;\p=(p);}},absolute slice={\py}{slice-r}{}},
...
partial edge={#2}{}{relative slice={.2}{slice}{\pic[blue,line width=1pt,fill=gray]{slice circle 1={.07 cm between (slice-2) and (slice-1)}};},},
partial edge={#3}{}{relative slice={.2}{slice}{\pic[blue,line width=1pt,fill=gray]{slice circle 1={.07 cm between (slice-2) and (slice-1)}};}},
/utils/exec={\pic[opacity=0,fill opacity=1,fill=gray!40]{slice circle 1=.07cm between (slice-r-2) and (slice-l-1)};\pic[blue,line width=1]{slice circle 2=.07cm between (slice-r-2) and (slice-l-1)};},
},
%minimum/.list={1,2,5},
%maximum/.list={12,13},
%saddle up={9}{12}{11},
...
%/only=<3>{saddle up={3}{7}{4},saddle up={6}{8}{10},saddle up={9}{12}{11}},
every edge={draw=black,opacity=.7,line width=1.5pt},
