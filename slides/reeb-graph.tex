...
\colorlet{saddle down color}{green!50!blue}
...
\pic{reeb graph={
minimum/.style={
partial edge={#1}{/reeb graph settings/.cd,outline edge={#1}{\thickness+.5*\linewidth}{fill=minimum color}}{relative up to={.2}{},relative down to={0}{}},
partial edge={#1}{/reeb graph settings/.cd,outline edge={#1}{\thickness-.5*\linewidth}{fill=gray!50}}{relative up to={.2}{},relative down to={0}{},relative slice={.2}{slice}{\pic[minimum color,line width=1pt,fill=gray]{slice circle 1={.07 cm between (slice-2) and (slice-1)}};}},
},
maximum/.style={
partial edge={#1}{/reeb graph settings/.cd,outline edge={#1}{\thickness+.5*\linewidth}{fill=maximum color}}{relative down to={-.2}{},relative up to={-0.001}{}},
...
partial edge={#1}{}{relative slice={-.2}{slice}{\pic[opacity=0,fill opacity=1,fill=gray!40]{slice circle 1={.07cm between (slice-2) and (slice-1)}};\pic[maximum color,line width=1pt]{slice circle 2={.07 cm between (slice-2) and (slice-1)}};}},
},
saddle up/.style n args={3}{
partial edge={#1}{/reeb graph settings/.cd,outline edge={#2}{\thickness+.5*\linewidth}{fill=saddle up color},outline edge={#3}{\thickness+.5*\linewidth}{fill=saddle up color}}{relative down to={-.2}{\coordinate (p);},relative up to={-0.001}{}},
partial edge={#2}{/reeb graph settings/.cd,outline edge={#2}{\thickness+.5*\linewidth}{fill=saddle up color}}{relative up to={.2}{},relative down to={0}{},/utils/exec={\tikzmath{coordinate \p;\p=(p);}},absolute slice={\py}{slice-l}{}},
partial edge={#3}{/reeb graph settings/.cd,outline edge={#3}{\thickness+.5*\linewidth}{fill=saddle up color}}{relative up to={.2}{},relative down to={0}{},/utils/exec={\tikzmath{coordinate \p;\p=(p);}},absolute slice={\py}{slice-r}{}},
partial edge={#1}{/reeb graph settings/.cd,outline edge={#2}{\thickness-.5*\linewidth}{fill=gray!40},outline edge={#3}{\thickness-.5*\linewidth}{fill=gray!40}}{relative down to={-.2}{},relative up to={-0.001}{}},
partial edge={#2}{/reeb graph settings/.cd,outline edge={#2}{\thickness-.5*\linewidth}{fill=gray!40}}{relative up to={.2}{},relative down to={0}{}},
partial edge={#3}{/reeb graph settings/.cd,outline edge={#3}{\thickness-.5*\linewidth}{fill=gray!40}}{relative up to={.2}{},relative down to={0}{}},
partial edge={#2}{}{relative slice={.2}{slice}{\pic[saddle up color,line width=1pt,fill=gray]{slice circle 1={.07 cm between (slice-2) and (slice-1)}};},},
partial edge={#3}{}{relative slice={.2}{slice}{\pic[saddle up color,line width=1pt,fill=gray]{slice circle 1={.07 cm between (slice-2) and (slice-1)}};}},
/utils/exec={\pic[opacity=0,fill opacity=1,fill=gray!40]{slice circle 1=.07cm between (slice-r-2) and (slice-l-1)};\pic[saddle up color,line width=1]{slice circle 2=.07cm between (slice-r-2) and (slice-l-1)};},
},
saddle down/.style n args={3}{
partial edge={#1}{/reeb graph settings/.cd,outline edge={#2}{\thickness+.5*\linewidth}{fill=saddle down color},outline edge={#3}{\thickness+.5*\linewidth}{fill=saddle down color}}{relative up to={.2}{\coordinate (p);},relative down to={0}{}},
partial edge={#2}{/reeb graph settings/.cd,outline edge={#2}{\thickness+.5*\linewidth}{fill=saddle down color}}{relative down to={-.2}{},relative up to={-0.001}{},/utils/exec={\tikzmath{coordinate \p;\p=(p);}},absolute slice={\py}{slice-l}{}},
partial edge={#3}{/reeb graph settings/.cd,outline edge={#3}{\thickness+.5*\linewidth}{fill=saddle down color}}{relative down to={-.2}{},relative up to={-0.001}{},/utils/exec={\tikzmath{coordinate \p;\p=(p);}},absolute slice={\py}{slice-r}{}},
partial edge={#1}{/reeb graph settings/.cd,outline edge={#2}{\thickness-.5*\linewidth}{fill=gray!40},outline edge={#3}{\thickness-.5*\linewidth}{fill=gray!40}}{relative up to={.2}{},relative down to={0}{}},
partial edge={#2}{/reeb graph settings/.cd,outline edge={#2}{\thickness-.5*\linewidth}{fill=gray!40}}{relative down to={-.2}{},relative up to={-0.001}{}},
partial edge={#3}{/reeb graph settings/.cd,outline edge={#3}{\thickness-.5*\linewidth}{fill=gray!40}}{relative down to={-.2}{},relative up to={-0.001}{}},
partial edge={#2}{}{relative slice={-.2}{slice}{\pic[opacity=0,fill opacity=1,fill=gray!40]{slice circle 1={.07cm between (slice-2) and (slice-1)}};\pic[saddle down color,line width=1pt]{slice circle 2={.07 cm between (slice-2) and (slice-1)}};}},
partial edge={#3}{}{relative slice={-.2}{slice}{\pic[opacity=0,fill opacity=1,fill=gray!40]{slice circle 1={.07cm between (slice-2) and (slice-1)}};\pic[saddle down color,line width=1pt]{slice circle 2={.07 cm between (slice-2) and (slice-1)}};}},
/utils/exec={\pic[saddle down color,line width=1,fill=gray]{slice circle 1=.07cm between (slice-r-2) and (slice-l-1)};},
},
manifold 1,
